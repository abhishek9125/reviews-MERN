...
function Header({ onAddActorClick, onAddMovieClick }) {
	...
	return (
		<div className='flex items-center justify-between relative'>
			<input
				type="text"
				className='border-2 dark:border-dark-subtle border-light-subtle dark:focus:border-white focus:border-primary transition 
				dark:text-white bg-transparent rounded text-lg p-1 outline-none m-2'
            ...
            <div className='flex items-center space-x-3'>
                ...
                <button
                    ...
                    transition font-semibold border-2 text-lg px-3'>
                    <span>Create</span>
                    <AiOutlinePlus />
                </button>
